...
if(isset($_POST["tc"]) && isset($_POST["name"]) && isset($_POST["surname"]) && isset($_POST["diplomaNo"]) &&
    ...
    $result = DoctorManager::insertNewDoctor($tc, $name, $surname, $diplomaNo, $graduateSchool,
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="http://localhost:8080/doctor/AddDoctor.php">Add a New Doctor</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="center-container">
                <div class="main">
                    <h1 class="w3layouts_head">Add a New Doctor</h1>
