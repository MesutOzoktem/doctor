    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="http://deu-doctor.hol.es/AssayRequest.php">Create Assay Request</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="center-container">
                <div class="main">
                    <h1 class="w3layouts_head">Create an Assay Request</h1>
                    <div class="w3layouts_main_grid">
                        <form>
                            ...
                            <div class="w3_agileits_main_grid w3l_main_grid">
								<span class="agileits_grid">
									<label>Assay Type <i>:</i></label>
									<input type="text" id="sendedAssay" name="assayType" placeholder="Assay" required="">
								</span>
                            </div>
                        ...
                        <script>
                            ...
                            $(document).ready(function() { // when DOM is ready, this will be executed
                                $("#btnSendedInfo").click(function(e) {
                                    ...
                                    var assayType = $("#sendedAssay").val();

                                    var url = "http://elitelaboratory.hol.es/NewAssayService.php";
